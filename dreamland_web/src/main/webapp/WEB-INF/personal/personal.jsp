...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/writedream?id=${sessionScope.user.id}">写梦</a></li>
            </ul>
            <ul class="nav navbar-nav" style="margin-left: 680px">
                <li><a href="${ctx}/list?id=${sessionScope.user.id}">${user.nickName}
...
<div class="author-card follow-box">
    <div class="designer-card card-media">
        ...
        <div class="avatar-container-80 center">
            <a href="#" title="${sessionScope.user.nickName}" class="avatar" target="_blank">
        ...
        <div class="author-info">
            <p class="author-info-title">
                <a href="#" title="${sessionScope.user.nickName}"
                   class="title-content" target="_blank">${sessionScopeuser.nickName}
                </a>
            </p>
            <div class="position-info">
                <span>长沙&nbsp;|&nbsp;Java工程师</span>
            </div>
            <div class="btn-area">
            ...
            <div style="float: left;margin-top: 40px; margin-left: 130px;">
                <a href="${ctx}/profile?id=${sessionScope.user.id}"><i class="icon icon-edit"></i><span style="margin-left: 10px">修改个人资料</span></a>
            </div>
        </div>
    </div>
...
<div class="ibx-advice" onmouseover="changeBackColor();" onmouseout="back2color();">
    <a href="${ctx}/writedream?id=${sessionScope.user.id}"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#1b1b1b;font-size:30px;" title="写梦"></span></a>
</div>
