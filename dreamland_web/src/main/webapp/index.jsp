    ...
    <nav class="navbar navbar-inverse">
        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">最新梦幻</a></li>
                <li><a href="#">最热梦幻</a></li>
                <li><a href="#">梦诗词</a></li>
                <li><a href="#">梦问答</a></li>
                <li><a href="#">我的梦</a></li>
        ...
        <div class="col-md-9"  style="background-color: white;">
                    ...
                    <span class="dash"> · </span>
                         <a  onclick="reply(${cont.id},${cont.userId});">
                            ...
                            <div class="stats-buttons bar clearfix">
                                ...
                                &nbsp;
                                <a style="cursor: pointer;" onclick="reply(${cont.id},${cont.userId});" title="点击打开或关闭">
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1}">
                        <li class="previous">
                            <a href="${ctx}/index_list?pageNum=${page.pageNum-1}&&id=${user.id}">
                                « 上一页
                            </a>
                        </li>
                    </c:if>
               ...
               <!-- rgba(60,63,65,0.31)-->
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p style="margin-top: 8px">&copy;www.dreamland.wang 梦幻家园网版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
